...
import com.admin.adminpannel.adapter.CategoryAdapter
import com.admin.adminpannel.databinding.FragmentCategoryBinding
...
class CategoryFragment : Fragment() {
           ...
           //Image View Button
            imageView.setOnClickListener {
                ...
                uploadCategory.setOnClickListener {
                    validData(binding.categoryName.text.toString())
                }
            }
            return binding.root
        }
    ...
    private fun validData(categoryName: String) {
